    ...
    <button id="tts-toggle" class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden leading-normal justify-center  rounded-lg  text-black dark:text-white text-sm font-bold border rounded-sm p-1 pr-3 pl-3  hover:bg-red-500">
        Ouvir
          ...
          <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Bem-vindo de volta! Insira seus dados para continuar.</p>
          </div>
          ...
          <form action="login.php" method="POST" class="space-y-6">
            ...
            <div>
              ...
              <div class="text-right mt-2">
                <a class="text-sm font-medium text-primary hover:underline" href="esqueci_senha.php">Esqueci minha senha</a>
              </div>
            </div>
            ...
            <div>
              <button 
                type="submit"
                class="flex w-full items-center justify-center rounded-lg h-12 px-5 bg-primary text-white font-bold hover:bg-primary/90 focus:ring-2 focus:ring-offset-2 focus:ring-primary transition">
                Entrar
              </button>
            </div>
          </form>
